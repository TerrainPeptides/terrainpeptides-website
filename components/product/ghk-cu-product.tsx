          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="research" className="mt-0 space-y-12 text-[1.1em]">
              ...
              <div>
                ...
                <p className="mt-0.5 text-sm text-[#0A1931]/60">Multi-pathway regeneration.</p>
              ...
              <div>
                ...
                <p className="mt-0.5 text-sm text-[#0A1931]/60">Summary of clinical and preclinical findings.</p>
                <div className="mt-4 grid gap-6 lg:grid-cols-2">
                  <Card className="border-[#0A1931]/10">
                    <CardContent className="p-6">
                      <span className="rounded-full bg-[#0A1931]/5 px-3 py-1 text-xs text-[#0A1931]/70">🗓️ 12-Week Facial Study — 71 Women</span>
                      <p className="mt-4 text-4xl font-bold" style={{ color: GREEN }}>55.8%</p>
                      <p className="text-xs font-medium uppercase tracking-wider text-[#0A1931]/70">Wrinkle volume reduction</p>
                      <p className="mt-4 text-sm font-semibold text-[#0A1931]">Wrinkle reduction comparison</p>
                      <div className="mt-3 space-y-3">
                        <div className="flex items-center gap-3">
                          <span className="w-32 shrink-0 text-xs text-[#0A1931]/70">GHK-Cu vs Control</span>
                        ...
                        <div className="flex items-center gap-3">
                          <span className="w-32 shrink-0 text-xs text-[#0A1931]/70">GHK-Cu vs Matrixyl</span>
                          <div className="h-3 flex-1 overflow-hidden rounded-full bg-[#0A1931]/10">
                            <div className="h-full rounded-full bg-[#0A1931]/40" style={{ width: '57%' }} />
                          </div>
                          <span className="text-xs text-[#0A1931]/70">-31.6%</span>
                        </div>
                        <div className="flex items-center gap-3">
                          <span className="w-32 shrink-0 text-xs text-[#0A1931]/70">Placebo</span>
                          <div className="h-3 flex-1 overflow-hidden rounded-full bg-[#0A1931]/10">
                            <div className="h-full rounded-full bg-[#0A1931]/20" style={{ width: '4%' }} />
                          </div>
                          <span className="text-xs text-[#0A1931]/70">-0%</span>
                        </div>
                      </div>
            ...
            <TabsContent value="coa" className="mt-0">
              ...
              <p className="mt-0.5 text-sm text-[#0A1931]/60">Third party tested by Freedom Diagnostics.</p>
              <div className="mt-6 flex flex-wrap gap-6">
                {COA_CARDS.map((coa) => (
                  <Card key={coa.lot} className="w-full min-w-[280px] max-w-[340px] border-[#0A1931]/10">
                    <CardContent className="p-6">
                      <span className="rounded bg-[#0A1931] px-2 py-0.5 text-xs font-medium text-white">LATEST</span>
                      <p className="mt-4 text-4xl font-bold" style={{ color: GREEN }}>{coa.purity}%</p>
                      <p className="text-xs font-medium uppercase tracking-wider text-[#0A1931]/60">Purity</p>
                      <dl className="mt-6 space-y-2 text-sm">
                        <div className="flex justify-between">
                          <dt className="text-[#0A1931]/60">Variant</dt>
                          <dd className="font-medium text-[#0A1931]">{coa.variant}</dd>
                        </div>
                        <div className="flex justify-between">
                          <dt className="text-[#0A1931]/60">Lot #</dt>
                          <dd className="font-medium text-[#0A1931]">{coa.lot}</dd>
                        </div>
                        <div className="flex justify-between">
                          <dt className="text-[#0A1931]/60">Labeled</dt>
                          <dd className="font-medium text-[#0A1931]">{coa.labeled}</dd>
                        </div>
                        <div className="flex justify-between">
                          <dt className="text-[#0A1931]/60">Actual</dt>
                          <dd className="font-medium" style={{ color: GREEN }}>{coa.actual}</dd>
                        </div>
                        <div className="flex justify-between">
                          <dt className="text-[#0A1931]/60">Tested</dt>
                          <dd className="font-medium text-[#0A1931]">{coa.tested}</dd>
                        </div>
                      </dl>
                      <Button
                        asChild
                        className="mt-6 w-full gap-2 bg-[#0A1931] text-white hover:bg-[#0A1931]/90"
                      >
