          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="research" className="mt-0 space-y-12 text-[1.1em]">
              ...
              <div>
                ...
                <p className="mt-0.5 text-sm text-[#0A1931]/60">Actin binding, angiogenesis, and repair signaling.</p>
                <div className="mt-4 grid gap-6 lg:grid-cols-5">
                  <Card className="border-[#0A1931]/10 lg:col-span-3">
                    <CardContent className="p-6">
                      ...
                      <h3 className="mt-2 font-bold text-[#0A1931]">How TB-500 Drives Tissue Repair</h3>
              ...
              <div>
                ...
                <div className="mt-4 grid gap-6 lg:grid-cols-2">
                  <Card className="border-[#0A1931]/10">
                    <CardContent className="p-6">
                      <span className="rounded-full bg-[#0A1931]/5 px-3 py-1 text-xs text-[#0A1931]/70">Preclinical & Translational Research — Thymosin Beta-4 Biology</span>
                      <p className="mt-4 text-4xl font-bold" style={{ color: GREEN }}>↑↑↑</p>
                      <p className="text-xs font-medium uppercase tracking-wider text-[#0A1931]/70">CELL MIGRATION, VASCULARIZATION & INFLAMMATION ALL MOVE IN THE RIGHT DIRECTION</p>
              ...
              <div>
                <p className="text-xs font-medium uppercase tracking-wider text-[#0A1931]/60">✨ Beyond tissue repair</p>
              ...
              <div>
                ...
                <p className="mt-0.5 text-sm text-[#0A1931]/60">Reported effects from preclinical and observational data.</p>
                <div className="mt-4 grid gap-6 lg:grid-cols-2">
                  <Card className="border-[#0A1931]/10">
                    <CardContent className="p-6">
                ...
                <div className="mt-4 grid gap-6 lg:grid-cols-3">
                  <Card className="border-[#0A1931]/10">
                    <CardContent className="p-6">
                      ...
                      <h4 className="mt-3 font-bold text-[#0A1931]">What Is TB-500?</h4>
                      <div className="mt-4 rounded-lg bg-[#0A1931]/5 p-4 space-y-2 text-sm">
                        <div className="flex justify-between"><span className="text-[#0A1931]/60">Type</span><span className="font-medium">Synthetic thymosin beta-4 fragment / TB-4 derived peptide</span></div>
                        <div className="flex justify-between"><span className="text-[#0A1931]/60">CAS</span><span className="font-medium">77591-33-4</span></div>
                        ...
                        <div className="flex justify-between"><span className="text-[#0A1931]/60">Weight</span><span className="font-medium">4,963 Da</span></div>
                        <div className="flex justify-between"><span className="text-[#0A1931]/60">Amino acids</span><span className="font-medium">43</span></div>
                        <div className="flex justify-between"><span className="text-[#0A1931]/60">Sequence</span><span className="font-mono text-xs">43-aa TB4-derived construct — full sequence on product COA</span></div>
                      </div>
                    </CardContent>
                  </Card>
                  <Card className="border-[#0A1931]/10">
